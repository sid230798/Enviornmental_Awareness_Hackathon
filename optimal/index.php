...
<div class="row100 bgded" style="background-image:url('images/demo/backgrounds/01.png');"> 
  ...
  <div class="wrapper row1">
    <section id="pageintro" class="clear"> 
      ...
      <ul class="nospace inline pushright">
        <li><a class="btn" href="https://www.nrdc.org/stories/air-pollution-everything-you-need-know">Air Pollution Causes</a></li>
        <li><a class="btn bg-red" href="https://www.nrdc.org/stories/air-pollution-everything-you-need-know">Air Pollution Solutions</a></li>
      </ul>
      <!-- ################################################################################################ -->
    </section>
  </div>
        ...
        <li>
          <figure class="group">
            ...
            <figcaption class="three_quarter">
              <p><?php echo substr($row['content'], 0, 10); ?><?php $url = "../generic.php?story_id=".$row['id']."&user_id=".$row['user_id']; ?><a href = "<?php echo $url; ?>" >...Readmore</a></p>
              <ul>
      ...
      <div class="one_third first">
        <figure><img src="images/demo/320x390.png" alt="">
          <figcaption class="bg-orange-trans">
            ...
            <footer><a class="btn bg-orange" href="https://www.nationalgeographic.com/environment/global-warming/pollution/">Global Warming</a></footer>
          </figcaption>
        </figure>
      </div>
      <div class="one_third">
        <figure><img src="images/demo/320x390.png" alt="">
          <figcaption class="bg-black-trans">
            ...
            <p>Duis semper ultrices eros id pharetra. Morbi in bibendum eros phasellus.</p>
            <footer><a class="btn" href="https://www.nrdc.org/stories/air-pollution-everything-you-need-know">Natural Ways</a></footer>
          </figcaption>
        </figure>
      </div>
      <div class="one_third">
